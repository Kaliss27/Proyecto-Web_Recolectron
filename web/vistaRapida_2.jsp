<%--
    Vista Rapida para Usuario Analista
...
<html>
    <head>
        ...
        <script src="Scripts/vistaRapida_2.js" type="text/javascript"></script>
    </head>
    <body>
            ...
            <div class="row">
                ...
                <div class="col-sm-3 sidenav">
                    <div id="dUser">
                        ...
                        <label>Usuario:</label>
                        <label id="tuser">Analista</label><br>
                        <label>Fecha:</label>
                        <%
                            Date dNow = new Date( );
                    ...
                    <div id="alc">
                        ...
                        <button type="button" class="btn btn-default" id='btn-Alc' onclick='dPanelAlc();'>
                            <label id="giconAlc" class="glyphicon glyphicon-resize-full"></label>
                        </button>
                    </div>
                    <br><br>
                </div>
